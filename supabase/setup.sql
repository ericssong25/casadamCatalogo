...
CREATE TABLE IF NOT EXISTS productos (
  ...
  tecnologia            TEXT,
  superficie            TEXT,
  grupo_absorcion       TEXT,
  clasificacion_ansi    TEXT,
  coeficiente_friccion TEXT,
  pei                   INTEGER,
  cantidad_caras        INTEGER,
  variacion_rate       INTEGER,
  ...
  trafico               TEXT,
  terrazas              BOOLEAN DEFAULT FALSE,
  alto_trafico          BOOLEAN DEFAULT FALSE,
  garantia_anios        INTEGER,
  garantia_unidad       TEXT DEFAULT 'años' CHECK (garantia_unidad IN ('años','meses')),
  garantia_condiciones  TEXT,
  pais_origen           TEXT,
  resistencia_manchas  BOOLEAN DEFAULT FALSE,
  detalle_instalacion   TEXT,
  observaciones         TEXT,
  politica_imagen      TEXT,
  created_at            TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at            TIMESTAMPTZ NOT NULL DEFAULT now()
);
